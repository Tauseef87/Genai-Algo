...
class ImproverResponse(BaseModel):
    current_plan: Annotated[
        str,
        ...,
        "Current plan to solve the problem.",
    ]
    modified_plan: Annotated[
        str, ..., "The updated or modified plan to solve the problem."
    ]
    modified_code: Annotated[str, ..., "The updated or modified python3 code."]
...
Use the feeback to update plan and improve code.
...
code_improver_agent = Agent(
    model=model,
    instructions=instructions,
    output_type=ImproverResponse,
)
